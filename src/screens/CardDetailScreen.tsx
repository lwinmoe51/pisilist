...
const taskStyles = (colors: ReturnType<typeof useTheme>['colors']) =>
  StyleSheet.create({
    ...
    checkbox: { width: 24, height: 24, borderRadius: 4, borderWidth: 2, borderColor: colors.placeholder, justifyContent: 'center', alignItems: 'center', marginTop: 1 },
    ...
    reminderRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 2, gap: 4 },
